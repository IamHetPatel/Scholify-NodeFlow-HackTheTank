var path1 = document.querySelector(".p1"),
  ...
  path3 = document.querySelector(".p3"),
  path4 = document.querySelector(".p4");
...
path1.setAttribute(
  "d",
  createLine([c1Pos.left, c1Pos.top], [c2Pos.left, c2Pos.top])
);
path2.setAttribute(
  "d",
  createLine([c1Pos.left, c1Pos.top], [c3Pos.left, c3Pos.top])
);
